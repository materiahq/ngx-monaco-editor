...
define("vs/editor/editor.main.nls.fr", {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"Si disponible, utilisez une stratégie de présentation langage-spécifique, sinon la stratégie d\'indentation s\'applique.",
		"Utilisez toujours l\'indentation basée sur la stratégie de présentation",
		"Contrôle la façon dont les repliages sont calculées. \'auto\' utilise une stratégie repliage spécifique au langage, si disponible. \'indentation\' force à ce que la stratégie de repliage basée sur l\'indentation soit utilisée.",
		...
		"Exécuter organiser les importations lors de l\'enregistrement ?",
		"Types d\'actions de code à exécuter lors de l\'enregistrement.",
		"Délai d\'attente pour les actions de code exécutées lors de l\'enregistrement.",
	...
	"vs/editor/contrib/format/formatActions": [
		...
		"Il n’y a aucun formateur de document installé pour les fichiers \'{0}\'.",
		"Mettre en forme la sélection",
		"Il n’y a aucun formateur de sélection installé pour les fichiers \'{0}\'.",
	],
