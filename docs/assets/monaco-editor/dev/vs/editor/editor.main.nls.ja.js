...
define("vs/editor/editor.main.nls.ja", {
	...
	"vs/editor/common/config/commonEditorConfig": [
		...
		"エディターが CodeLens を表示するかどうかを制御します",
		"エディターでコードの折りたたみを有効にするかどうかを制御します",
		"利用可能であれば、言語に特有の折りたたみ方式を使用して、そうでない場合はインデント方式に戻ります。",
		"常にインデントに基づく折りたたみ方式を使用します",
		"折りたたみ範囲の計算方法を制御します。\'auto\' は利用可能であれば言語固有の折りたたみ方式を使用します。\'indentation\' は常にインデントに基づく折りたたみ方式を使用します。",
		...
		"保存時にインポートの整理を実行しますか?",
		"保存時に実行されるコード アクションの種類。",
		"保存時に実行されるコード アクションのタイムアウト値。",
	...
	"vs/editor/contrib/format/formatActions": [
		...
		"ドキュメントのフォーマット",
		"インストールされた \'{0}\'ファイル用のドキュメント フォーマッターが存在しません。",
		"選択範囲のフォーマット",
		"インストールされた \'{0}\' ファイル用の選択範囲フォーマッターが存在しません。",
	],
