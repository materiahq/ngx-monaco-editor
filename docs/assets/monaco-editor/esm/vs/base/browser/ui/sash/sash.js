...
import { getElementsByTagName, EventHelper, EventType as DOMEventType, createStyleSheet, addDisposableListener } from '../../dom.js';
...
var Sash = /** @class */ (function () {
    function Sash(container, layoutProvider, options) {
        ...
        this.$e.on(DOMEventType.MOUSE_DOWN, function (e) { _this.onMouseDown(e); });
        this.$e.on(DOMEventType.DBLCLICK, function (e) { return _this._onDidReset.fire(); });
    ...
    Sash.prototype.onTouchStart = function (event) {
        ...
        listeners.push(addDisposableListener(this.$e.getHTMLElement(), EventType.Change, function (event) {
        ...
        listeners.push(addDisposableListener(this.$e.getHTMLElement(), EventType.End, function (event) {
            _this._onDidEnd.fire();
            dispose(listeners);
        }));
    };
